...
<div class="left_content">
    @include('contents.app_webablls_analysisList_left_pan')
</div>
@endsection

@section('right_top_content')
<div class="right_top_content">
    @include('contents.app_webablls_analysisList_right_top_content')
</div>
@endsection

@section('right_bottom_content')  
<div class="right_bottom_content">
    @include('contents.app_webablls_analysisList_right_bottom_content')
</div>
@endsection
