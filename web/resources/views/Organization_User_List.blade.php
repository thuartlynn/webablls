...
@section('title', 'Organization User List')
...
<div class="left_content">
    @include('contents.app_webablls_organization_user_list_left_pan')
</div>
@endsection

@section('right_top_content')
<div class="right_top_content">
    @include('contents.app_webablls_organization_user_list_right_top_content')
</div>
@endsection

@section('right_bottom_content')
<div class="right_bottom_content">
    @include('contents.app_webablls_organization_user_list_right_bottom_content')
</div>
@endsection
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('#filter').click(function(event) {
            ...
            var Email_hide = document.getElementById("Email_hide");
            ...
            Email_hide.value = Email.value;
            if (document.createEventObject) {
                Email_hide.fireEvent("onchange");
            } else {
                var evt = document.createEvent("HTMLEvents");
                evt.initEvent("change", false, true);
                Email_hide.dispatchEvent(evt);
            }
            $("#UserTable tr").removeClass("selected");
            $('#actions').addClass('disable');
        });
        ...
        $('#clear').click(function() {
            ...
            var Email_hide = document.getElementById("Email_hide").value ="";
        });
