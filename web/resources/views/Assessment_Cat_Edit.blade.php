...
@section('title', 'Assessment Cat Edit')
...
<style>
    ...
    .tgv-category .b.se {
	    margin: 15px 5px 4px 7px!important;
    }
    .tgv-category .b.p {
	    margin: 15px 5px 4px 7px!important;
    }
...
<div class="left_content">
    @include('contents.app_webablls_assessment_cat_edit_left_pan')
</div>
@endsection

@section('right_top_content')
<div class="right_top_content">
    @include('contents.app_webablls_assessment_cat_edit_right_top_content')
</div>
@endsection

@section('right_bottom_content')
<div class="right_bottom_content">
    @include('contents.app_webablls_assessment_cat_edit_right_bottom_content')
</div>
@endsection
            ...
            if (!$(this).hasClass("app-disable")) {
                if ($(this).data("index") == "Save") {
                    ...
                    if (category_select >= category_table.length)
                        category_select = 0;
                    location.href = "/Assessment/TgvCatEdit/{{$AssInfo->get('AssID')}}/?filter=" + category_table[category_select];
