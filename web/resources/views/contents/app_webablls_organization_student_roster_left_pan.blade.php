...
?>
  <nav class="navbar app-left-pan-bg app-nopadding-nomargin">
    <ul id="actions" class="navbar-nav app-left-pan-list-mr-pd disable">
      <li class="nav-item app-left-pan-point" data-path="/Organization/Students/EditProfile/">Edit Profile</li>
      <li class="nav-item app-left-pan-point" data-path="/Organization/Students/ViewHistory/">View History</li>
      <li class="nav-item app-left-pan-point" data-path="/Organization/Students/UserLinks/">Share Permissions by Student</li>
      <li class="nav-item app-left-pan-point" data-path="Archive">Archive</li>
    </ul>
  </nav>
</div>
