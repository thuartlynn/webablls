...
?>
  <nav class="navbar app-left-pan-bg app-nopadding-nomargin">
    <ul id="actions" class="navbar-nav app-left-pan-list-mr-pd">
      <li class="nav-item app-left-pan-point" data-path="" onclick="TriggerSubmit()">Save Details</li>
      <li class="nav-item app-left-pan-point" data-path="/Organization/Users">Back</li>
    </ul>
  </nav>
</div>