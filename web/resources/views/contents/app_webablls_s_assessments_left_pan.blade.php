...
?>
  ...
  <nav class="navbar app-left-pan-bg app-nopadding-nomargin">
    <ul id="actions" class="navbar-nav app-left-pan-list-mr-pd disable">
      <li class="nav-item app-left-pan-point" data-path="/Assessment/Details/">Assessment Details</li>
      <li class="nav-item app-left-pan-point" data-path="/Assessment/TgvGridEdit/">Grid Mode</li>
      <li class="nav-item app-left-pan-point" data-path="/Assessment/TgvTextEdit/">Text Mode</li>
      <li class="nav-item app-left-pan-point" data-path="/Assessment/TgvCatEdit/">Cat Mode</li>
    </ul>
  </nav>
</div>