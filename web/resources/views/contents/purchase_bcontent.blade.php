<div class="container mx-auto">
        <form action="/purchase" method="post" role="form" class="needs-validation" novalidate autocomplete="on">{{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <?php
                if (Session::has('OrgInfo'))
                    {
                        $OrgInfo = Session::get('OrgInfo');

                        echo '<input type="text" class="form-control" id="organization_name" name="organization_name" value="';
                        echo $OrgInfo->get("name");
                        echo '" required />';
                    } else {
                        echo '<input type="text" class="form-control" id="organization_name" name="organization_name" required />';
                    }
                ?>
            ...
            <script>
                var x = <?php echo $OrgInfoN?>;
                var y = <?php echo $OrgInfoType?>;
                if ( x == 0) {
            ...
            <div class="form-group mt-5">
                ...
                <?php
                    if (Session::has('OrgInfo'))
                    {
                        echo '<input type="text" class="form-control" id="Address_name" name="Address_name" value="';
                        echo $OrgInfo->get("address");
                        echo '" placeholder="ex: John Doe" required />';
                    } else {
                        echo '<input type="text" class="form-control" id="Address_name" name="Address_name" value="" placeholder="ex: John Doe" required />';
                    }
                ?>
            ...
            <div class="form-group">
                ...
                <?php
                    if (Session::has('OrgInfo'))
                    {
                        echo '<input type="text" class="form-control" id="Address_street" name="Address_street" value="';
                        echo $OrgInfo->get("street");
                        echo '" placeholder="ex: San Pedro St." required />';
                    } else {
                        echo '<input type="text" class="form-control" id="Address_street" name="Address_street" value="" placeholder="ex: San Pedro St." required />';
                    }
                ?>
                <div class="valid-feedback">Valid.</div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <?php
                        if (Session::has('OrgInfo'))
                        {
                            echo '<input type="text" class="form-control mr-3" id="Address_city" name="Address_city" value="';
                            echo $OrgInfo->get("city");
                            echo '" placeholder="ex: Los Angeles" required />';
                        } else {
                            echo '<input type="text" class="form-control mr-3" id="Address_city" name="Address_city" placeholder="ex: Los Angeles" required />';
                        }
                    ?>
                    <div class="valid-feedback">Valid.</div>
                ...
                <label for="Address_zipcode" class="mr-3">Zip/Postal code</label>
                    <?php
                        if (Session::has('OrgInfo'))
                        {
                            echo '<input type="text" class="form-control" id="Address_zipcode" name="Address_zipcode" value="';
                            echo $OrgInfo->get("zipcode");
                            echo '" placeholder="ex: 90001" required />';
                        } else {
                            echo '<input type="text" class="form-control" id="Address_zipcode" name="Address_zipcode" value="" placeholder="ex: 90001" required />';
                        }
                    ?>
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="row mt-3">
                <div class="col">
                    ...
                    <?php if (Session::has('OrgInfo')){
                            echo '<select class="selectpicker countrypicker custom-select " data-live-search="true" name="Address_country" id="country" data-default="';
                            echo $OrgInfo->get("country");
                            echo '"></select>';
                        }else {
                            echo '<select class="selectpicker countrypicker custom-select " data-live-search="true" name="Address_country" id="country"></select>';
                        }
                    ?>
                </div>
                <div class="col">
                    ...
                    <?php
                        if (Session::has('OrgInfo'))
                        {
                            echo '<input type="text" class="form-control" id="Address_state" name="Address_state" value="';
                            echo $OrgInfo->get("state");
                            echo '" required />';
                        } else {
                            echo '<input type="text" class="form-control" id="Address_state" name="Address_state" value="" required />';
                        }
                    ?>
                    <div class="valid-feedback">Valid.</div>
            ...
            <div class="form-group mt-3">
                ...
                <?php
                        if (Session::has('OrgInfo'))
                        {
                            echo '<input type="text" class="form-control" id="phone" name="phone" value="';
                            echo $OrgInfo->get("state");
                            echo '" placeholder="+99(99)9999-9999" required />';
                        } else {
                            echo '<input type="text" class="form-control" id="phone" name="phone" value="" placeholder="+99(99)9999-9999" required />';
                        }
                    ?>
                <div class="valid-feedback">Valid.</div>
