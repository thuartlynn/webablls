<div id="Warning_message" class="container bg-yellow mt-3 mb-3 app-right-bottom-mr hide">
  <div class="row justify-content-center align-items-center" style="text-align: center;">
    <span id="Warning_message_text" class="mt-3 mb-3 app-nopadding-nomargin Warning-message-content">Entered current password is invalid</span>  
  </div>
</div>

<form action="{{url('/Account/ChangePassword')}}" class="app-inline" id="ChangePasswordfrm" method="post">
  {{ csrf_field() }}
  <div class="app-right-bottom-mr">
    <label class="app-right-bottom-title" for="Current_Password">Current Password</label>
    <input class="app-right-bottom-input form-control app-option-font app-right-bottom-content-mr" id="CurrentPassword" name="CurrentPassword" type="password" value="" oninput="Listener(event)" onporpertychange="Listener(event)"/>
  </div>
  ...
  <ul class="app-list-ul app-right-bottom-mr">
    <li id="list-input-pw" style="margin-left: -10px; list-style-type: none; color: red;" class="app-list-item app-right-bottom-content"><i class="fas fa-times fa-lg mr-1"></i>Enter current password</li>
    <li id="list-input-pw-v" style="margin-left: -10px; list-style-type: none;" class="app-disappear app-list-item app-right-bottom-content list-group-item-success"><i class="fas fa-check mr-1"></i>Enter current password</li>
    ...
    <li id="list-input-pw-lower" style="margin-left: -10px; list-style-type: none; color: red;" class="app-list-item app-right-bottom-content"><i class="fas fa-times fa-lg mr-1"></i>Password must include at least 1 lower case character</li>
