...
<form action="{{url('/Account/ChangeDetails')}}" class="app-inline needs-validation" id="ChangeDetailsfrm" method="post" role="form" novalidate>
  {{ csrf_field() }}
  <div>
  ...
  <div class="app-right-bottom-mr">
    ...
    <input class="app-right-bottom-input form-control app-option-font app-right-bottom-content-mr" id="FirstName" name="FirstName" type="text" value="<?php echo Auth::user()->first_name?>" required/>
  ...
  <div class="app-right-bottom-mr">
    ...
    <input class="app-right-bottom-input form-control app-option-font app-right-bottom-content-mr" id="LastName" name="LastName" type="text" value="<?php echo Auth::user()->last_name?>" required/>
  ...
  <div class="app-right-bottom-mr">
    ...
    <input class="app-right-bottom-input form-control app-option-font app-right-bottom-content-mr" id="PhoneNumber" name="PhoneNumber" type="text" value="<?php echo Auth::user()->phone_number?>" />
  </div>
