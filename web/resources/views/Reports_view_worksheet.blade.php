...
@section('title', "Porgram Worksheet")
...
<div class="left_content">
    @include('contents.app_webablls_worksheet_left_pan')
</div>
@endsection

@section('right_top_content')
<div class="right_top_content">
    @include('contents.app_webablls_worksheet_right_top_content')
</div>
@endsection

@section('bottom_content')
<div class="bottom_content">
    @include('contents.app_webablls_worksheet_bottom_content')
</div>
@endsection
