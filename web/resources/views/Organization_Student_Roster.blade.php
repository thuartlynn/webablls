...
<div class="left_content">
    @include('contents.app_webablls_organization_student_roster_left_pan')
</div>
@endsection

@section('right_top_content')
<div class="right_top_content">
    @include('contents.app_webablls_organization_student_roster_right_top_content')
</div>
@endsection

@section('right_bottom_content')
<div class="right_bottom_content">
    @include('contents.app_webablls_organization_student_roster_right_bottom_content')
</div>
@endsection
    ...
    $(function () {
        ...
        $("#actions li").click(function(e) {
            if ($("#UserTable tr").not(this).hasClass("selected")) {
                if ($(this).data("path") != "Archive") {
                    location.href=$(this).data("path") + select;
                } else {
                    var Url = "{{url('Organization/Students/Archive')}}" + "/" + select;
                    $.ajax({
                        url: Url,
                        cache: false
                    }).done(function(data) {
