...
//Privacy Policy
Route::get('/Anaytics_View',function () {
...
//Send Contact email
Route::post('/contact',"SupportController@SendContactMessage");
...
Route::group(['prefix' => 'Dashboard'],function() {
    ...
    Route::get('/BulletinBoard/Download/{ID}', 'DashboardController@DownloadBulletinFile');    
...
Route::group(['prefix' => 'Student'],function() {
     ...
     Route::get('/Files/{Seat_id}/{File_id}','StudentController@FileDownload');   
     ...
     Route::post('/profile/{Seat_id}','StudentController@UpdateProfile');
     Route::post('/Files/{Seat_id}','StudentController@FileProcess');   
     Route::post('/ShareStudent/{Seat_id}','OrganizationController@UpdateStudentPermission');  
     Route::post('/AddAssess/{Seat_id}','StudentController@AddAssessment');
});
//Account 
...
Route::group(['prefix' => 'Assessment'],function() {
    ...
    Route::get('/DetailsEdit/{Assid}','AssessmentController@showDetailEdit');
    ...
    // Route::get('/TgvGridEdit/{Assid}/{Skill_ID}', function(){
    //     return __('AssessmentController@showTaskInfoBox');
    // });  

    Route::post('/TgvEditSave','AssessmentController@TgvGridEditSaving');
    Route::get('/TgvReport/{Assid}','AssessmentController@DownloadTgvReport');
    Route::get('/CompletedItemsIncompletedItems/Report/{Assid}','AssessmentController@DownloadCompletedReport');
    Route::post('/delete/{Assid}','AssessmentController@DeleteAssessment');
    Route::post('/task-box-info/add','AssessmentController@AddTaskInfoNote');
    Route::post('/task-box-info/save','AssessmentController@UpdateTaskInfoNote');
    Route::post('/task-box-info/remove','AssessmentController@DeleteTaskInfoNote');
    Route::post('/DetailsEdit/{Assid}','AssessmentController@UpdateDetailEdit');
});
...
Route::group(['prefix' => 'Organization'],function() {
    ...
    Route::get('/BulletinBoard','OrganizationController@ShowBulletinBoard');
    ...
    Route::get('/Manage/ResetUserPassword/{UserID}','OrganizationController@ResetUserPassword');
    Route::get('/Students/EditProfile/{Seat_id}','OrganizationController@ShowStudentProfile');
    Route::get('/Students/ViewHistory/{Seat_id}','OrganizationController@ShowStudentHistory');
    ...
    Route::post('/BulletinBoard/Add','OrganizationController@UpdateBulletinBoard');
    Route::post('/BulletinBoard/Delete','OrganizationController@DeleteBulletin');
    Route::get('/BulletinBoard/Download/{FileID}','OrganizationController@DownloadBulletin');    
});
